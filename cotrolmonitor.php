<?php
    ...
    $query_aluno = "insert INTO monitor (nome,formacao,email,senha) VALUES ('".$dados['nome']."','".$dados['formacao']."', '".$dados['email']."', '".$dados['senha']."')";//insere os dados na tabela monitor
...
<body>
    <h1 align = "center">Sucesso no Casdastro do Monitor</h1>
